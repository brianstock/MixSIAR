...
The Lake Example data is simulated based on [Francis et al. 2011](https://onlinelibrary.wiley.com/doi/10.1111/j.1461-0248.2011.01597.x/full) and we include it as a example of how MixSIAR can include a **continuous effect**. Here we examine the diet of zooplankton in 21 lakes using:
