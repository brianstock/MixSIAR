...
The "Geese Example" uses data from [Inger et al. (2006)](https://onlinelibrary.wiley.com/doi/10.1111/j.1365-2656.2006.01142.x/full) of 251 wintering geese feeding on terrestrial grasses, Zostera spp., Enteromorpha spp., and Ulva lactuca. This is the same data included as a demo in SIAR and in [Parnell et al. (2013)](https://onlinelibrary.wiley.com/doi/10.1002/env.2221/full):
