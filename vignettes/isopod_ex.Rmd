...
Note that [Galloway et al. 2014](https://www.int-res.com/abstracts/meps/v507/p219-232) conducted feeding trials to create a "resource library". In the mixing model, the sources are actually consumers fed exclusively each of the sources. This allowed them to set the discrimination = 0 (see `isopod_discrimination.csv`).
