...
g.iso <- plot_data(filename="isospace_plot", 
          plot_save_pdf=TRUE,
          plot_save_png=FALSE,
          mix, source, discr, return_obj=TRUE)
...
# save workspace with fit model to use in modify_output vignette
# save.image("/home/brian/Documents/MixSIAR/Manual/wolves_normal.RData")
...
#   save summary stats and diagnostics to txt files
#   save diagnostic plots to file (xy and pairs)
...
# Get diagnostics, summary statistics, and posterior plots
df.stats <- output_stats(jags.1, mix, source, output_options)
df.diag <- output_diagnostics(jags.1, mix, source, output_options)
g.post <- output_posteriors(jags.1, mix, source, output_options)

# save workspace with fit model to use in modify_output vignette
# save.image("/home/brian/Documents/MixSIAR/Manual/wolves_normal_output.RData")
