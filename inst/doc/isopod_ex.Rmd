...
The Isopod Example is from [Galloway et al. 2014](https://doi.org/10.3354/meps10860) and demonstrates MixSIAR applied to an **8-dimensional fatty acid dataset**. Here the mixture data are isopod polyunsaturated fatty acid (PUFA) profiles, with 5 replicates at each of 6 sites in Puget Sound, WA:
